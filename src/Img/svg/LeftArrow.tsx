...
import { TArrows } from './RightArrow';

export const LeftArrow: React.FC<TArrows> = ({ onClick }) => {
  return (
    <div onClick={onClick} className={s.arrow}>
      <svg
        ...
        <g id="SVGRepo_iconCarrier">
          {' '}
          <title>arrow-left-circle</title> <desc>Created with Sketch Beta.</desc> <defs> </defs>{' '}
          <g
            id="Page-1"
            stroke="none"
            stroke-width="1"
